# create a security group resource for web
...
# create a security group resource inbound rules
...
# create a security group resource for default outbound rules
...
# create a security group resource for db
...
# create a db security group resource for inbound rules
...
# create a db security group resource for default outbound rules
